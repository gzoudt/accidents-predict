...
with col_stat2:
    ...
    fig_state = px.bar(
        state_counts, x='State', y='Count', title="Top 10 States with Most Accidents", 
        text_auto='.2s', color='Count', color_continuous_scale='Reds'
    )
...
with col_map_type: map_style_choice = st.radio("Map Type:", ["Scatter Map", "Heatmap", "Animated (By Hour)"], horizontal=True)
with col_slider:
